...
#define STRING_CONFIG_H_AUTHOR "(alexyao2015, Artillery Genius)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
  // Tuned to 205C
    #define DEFAULT_Kp  17.5530
    #define DEFAULT_Ki   1.2314
    #define DEFAULT_Kd  62.5525
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Tuned to 60C
  #define DEFAULT_bedKp 33.3672
  #define DEFAULT_bedKi 5.2901
  #define DEFAULT_bedKd 140.3091
...
// set true if using endstop as probe
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.121, 80.121, 399.778, 427.8599 }
...
// #define DEFAULT_RETRACT_ACCELERATION  8000    // artillery default
 ...
 */
// Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN is defined so Z_MIN_PIN is not used
// Ignore comment below

// Z_MIN_PIN is still the same as the default 18, allowing to use the default endstop
// Prevents destroying bed if probe is broken
// Connects to the W pin on the genius
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27.3, -35, 0 } // current z offset -2.94
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN 2                // Filament runout moved to x_max_pin
